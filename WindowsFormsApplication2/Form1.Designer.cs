namespace WindowsFormsApplication2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label11.Location = new System.Drawing.Point(171, 32);
            this.label11.Name = "label11";
            this.label11.Size = new System.Drawing.Size(18, 13);
            this.label11.TabIndex = 11;
            this.label11.Text = "kJ";
            // 
            // label12
            // 
        ...
        private void setTextLbl06(string text)
        {
            //label6.ResetText();
            if (label6.InvokeRequired)
            {
                Invoke(new SetTextCallback(setTextLbl06), new object[] { text });
            }
            else
            { label6.Text = text; }
        ...
        private void setTextLbl04(string text)
        {
            //label6.ResetText();
            if (label4.InvokeRequired)
            {
                Invoke(new SetTextCallback(setTextLbl04), new object[] { text });
            }
            else
            { label4.Text = text; }
        ...
        private void setTextLbl08(string text)
        {
            //label6.ResetText();
            if (label8.InvokeRequired)
            {
                Invoke(new SetTextCallback(setTextLbl08), new object[] { text });
            }
            else
            { label8.Text = text; }

        }
        private void setTextLbl10(string text)
        {
            //label6.ResetText();
            if (label10.InvokeRequired)
            {
                Invoke(new SetTextCallback(setTextLbl10), new object[] { text });
            }
            else
            { label10.Text = text; }
        ...
        private void setTextLbl02(string text)
        {
            //label6.ResetText();
        ...
        private void setTextLbl12(string text)
        {
            //label6.ResetText();
            if (label12.InvokeRequired)
            {
                Invoke(new SetTextCallback(setTextLbl12), new object[] { text });
            }
            else
            { label12.Text = text; }
